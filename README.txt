=== WP Share & Like Button ===
Contributors: vivacityinfotech.jaipur,startbititsolutions
...
A Simple FB Share & Like Button for your posts/home/pages/archive.
...
* English(US) (en_Us) - [Team Startbit](https://startbitsolutions.com/)
* Serbian (sr_RS) - [Team Startbit](https://startbitsolutions.com/)

If you have created your own language pack, or have an update of an existing one, you can send [gettext PO and MO files](http://codex.wordpress.org/Translating_WordPress) to [us](https://www.startbitsolutions.com/contact.html) so that We can bundle it into this plugin.
...
1. Download the WP Like Button Plugin.
...
1. WP Like Button plugin installed and appears in the plugins menu.
2. WP FB Like Button Appearance Settings Section.
3. WP FB Like Button Position Settings Section.
4. Displaying WP FB Like Button after your post.


== Changelog ==

= 2.3 =
*Compatible with Wordpress Latest Version 5.2.2.
